...
<head>
    ...
    <title>Comprehensive DataDirect vs AliveData Analysis</title>
...
<body>
    <div class="container">
        <div class="header">
            <h1>Comprehensive DataDirect vs AliveData Analysis</h1>
        ...
        <div class="chart-container">
            ...
            <div class="warning">
                <h4 style="color: #856404; margin-top: 0;">⚠️ DataDirect Hash Quality Issue</h4>
                ...
                <ul>
                    ...
                    <li><strong>Conclusion:</strong> AliveData has 100% hash integrity, DataDirect has corrupted hashes</li>
                </ul>
            </div>
        </div>
        ...
        <div class="insights">
            ...
            <ul>
                ...
                <li><strong>Data Quality:</strong> Address DataDirect hash corruption issues</li>
            </ul>
        </div>
        
        <div style="text-align: center; margin-top: 40px; padding-top: 20px; border-top: 1px solid #eee; color: #666;">
            <p><em>Report generated by Expert Data Scientist using DuckDB analysis engine</em></p>
        </div>
    </div>
</body>
</html>"""
...
def generate_charts(stats: List[MatchStats], dd_count: int, ad_count: int, compound_stats: List[Dict]) -> str:
    ...
    fig3 = go.Figure(data=[
        go.Bar(name='Matches', x=compound_names, y=compound_matches, 
               marker_color='#2ca02c',
    ...
    fig4 = go.Figure(data=[
        go.Bar(name='DataDirect Match Rate', x=compound_names, y=compound_dd_rates, marker_color='#1f77b4'),
        go.Bar(name='AliveData Match Rate', x=compound_names, y=compound_ad_rates, marker_color='#dc3545')
    ])
...
def generate_markdown_report(data: Dict) -> str:
    ...
    # Core stats table
    core_table = "| Field | Matches | DD Rate | AD Rate | Jaccard | DD Only | AD Only |\n|-------|---------|---------|---------|---------|---------|----------|\n"
    for stat in data['core_stats']:
...
### Critical Discovery
**AliveData maintains 100% hash integrity** while **DataDirect contains {hash_data['invalid_hashes']:,} corrupted email hashes**.
...
4. **Data Quality:** Address DataDirect hash corruption issues
