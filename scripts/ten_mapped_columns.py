#!/usr/bin/env python3
"""Load and compare the 10 mapped columns."""
...
def compare_ten_mapped():
    """Compare the 10 mapped columns."""
    ...
    report_file = output_path / "ten_mapped_columns.html"
    report.show_html(str(report_file))
    logger.info(f"Ten mapped columns comparison saved to: {report_file}")
