#!/usr/bin/env python3
"""Dataset comparison v1.0 - Load columns in the same order for proper Sweetviz comparison."""
...
def compare_datasets():
    ...
    report_file = output_path / "dataset_comparison_v1.html"
    report.show_html(str(report_file))
    logger.info(f"Dataset comparison v1 saved to: {report_file}")
